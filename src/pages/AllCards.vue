...
<script>
  ...
  import BankInformation from "@/components/settings/BankInformation";
  import BusinessLogo from "@/components/settings/BusinessLogo";
  ...
  import PendingTransaction from "@/components/transaction/PendingTransaction";
  export default {
    components: {
      AccountSettings,
      BankInformation,
